...
function Pagina(){
    return(
        <div className="pagina">
            <Cabecalho/>
            <h1 className='titulo-pagina'>Projeto Ubuntu</h1>
            <div>
                ...
                <div className='container-pagina-2'>
                    ...
                    <p className='resposta'>A ideia é arrecadar agasalhos, cobertores e dinheiro para compra desses para 
                ...
                <div className='container-pagina-2'>
                    ...
                    <p className='resposta'>Entre em contato comigo pelo WhatsApp 31-991791585, para combinarmos o dia e 
                     o local para entregar sua doação!
                    </p>
                </div>
            </div>
        </div>
